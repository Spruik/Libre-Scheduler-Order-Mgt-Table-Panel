...
System.register([], function (_export, _context) {
  ...
  var STATE_PLAN, STATE_READY, STATE_FLAG, STATE_START, STATE_PAUSE, STATE_COMPLETE, STATE_CLOSE, STATE_DELETED, STATE_REPLACED;
  return {
    setters: [],
    execute: function () {
      ...
      _export('STATE_DELETED', STATE_DELETED = 'deleted');

      _export('STATE_DELETED', STATE_DELETED);

      _export('STATE_REPLACED', STATE_REPLACED = 'replaced');

      _export('STATE_REPLACED', STATE_REPLACED);
    }
  };
});
